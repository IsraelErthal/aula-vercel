...
import "./App.css";
import fotoIsrael from "./assets/israel.jpeg";
...
function TerminalHero() {
  ...
  return (
    <div
      className="isr-terminal-header"
      role="img"
      aria-label="Terminal animado mostrando inicialização do perfil"
    >
        ...
        <section className="isr-section" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="isr-section-body">
            <p className="isr-about-text">
              ...
              <strong>robótica</strong> e por desafios que me fazem crescer. Estou
              construindo minha trajetória com dedicação, curiosidade e muita vontade
              de transformar <strong>ideias em soluções reais</strong>.
            </p>
          </div>
        </section>
